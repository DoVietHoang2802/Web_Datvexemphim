...
-- Thử chèn 1 đơn hàng đồ ăn cho một Payment đã tồn tại
INSERT INTO `food_order` (`payment_id`, `ticket_id`, `original_buyer_id`, `current_owner_id`, `total_price`, `food_order_status`) 
VALUES (1, 3, 3, 3, 150000.00, 'PENDING');


-- Clear ghost PENDING tickets & failed payments
